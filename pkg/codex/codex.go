...
func New[C Code](e C) error {
	return &ecodeError[C]{code: e}
}

func Errorf[C Code](e C, format string, args ...any) error {
	return &ecodeError[C]{code: e, msg: format, args: args}
}
...
func Wrap[C Code](e C, cause error) error {
	...
	return &ecodeError[C]{code: e, cause: cause, args: []any{cause}}
}
...
func Wrapf[C Code](e C, cause error, format string, args ...any) error {
	...
	return &ecodeError[C]{code: e, cause: cause, msg: format, args: append(args, cause)}
}

type ecodeError[C Code] struct {
	code  C
	msg   string
	args  []any
	cause error
...
func (e *ecodeError[C]) Error() string {
	msg := e.code.Message()
	if len(e.msg) > 0 {
		msg += ". " + e.msg
	}
...
func (e *ecodeError[C]) Code() C {
	return e.code
}

func (e *ecodeError[C]) Unwrap() error {
	return e.cause
}

func (e *ecodeError[C]) Is(err error) bool {
	var target *ecodeError[C]
